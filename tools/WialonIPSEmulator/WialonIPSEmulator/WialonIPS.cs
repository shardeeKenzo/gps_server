...
public class ShortDataMessage : Message
{
    ...
    {
        if (val.HasValue) sb.Append(val.Value);
        else sb.Append("NA");
    }
    ...
    protected void AppendCommonTextData(StringBuilder res)
    {
        ...
        if (this._lon.HasValue)
        {
            ...
            res.Append("NA;E;");
        if (this._speed.HasValue) res.Append(this._speed.Value);
        else res.Append("NA");
        res.Append(";");
...
public class ShortDataMessageAns : Message
{
    ...
    public ShortDataMessageAns(string code)
    {
        ...
        case "1":
            ...
            break;
        case "10":
            this.Description += ": wrong coordinates";
            break;
        case "11":
            this.Description += ": wrong speed, course or altitude";
            break;
        case "12":
            this.Description += ": wrong sats number";
            break;
        }
    }
...
public class DataMessage : ShortDataMessage
{
    ...
    public override string GetTextData()
    {
        ...
        this.AppendCommonTextData(res);
        res.Append(";");
        if (this._hdop.HasValue) res.Append(this._hdop.Value.ToString().Replace(',', '.'));
        else res.Append("NA");
        res.Append(";");
